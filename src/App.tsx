...
const INITIAL_ELEMENTS: CanvasElement[] = [
  {
    ...
    zIndex: 1,
    status: 'operational',
    description: 'Status: Nominal. Efficiency 98%.'
  },
  {
    ...
    zIndex: 1,
    status: 'operational',
    description: 'Flow rate stable. Filtration units active.'
  },
  {
    id: 'comm-array',
    type: 'equipment',
    ...
    zIndex: 1,
    status: 'operational',
    description: 'Signal strength: 98%. No anomalies.'
  },
];
...
const translations: Record<string, Record<string, string>> = {
  ...
  zh: {
    ...
    thisMayTakeAMoment: '正在驅動新一代 Flash 引擎...',
    ...
    panMode: '平移',
    selectMode: '選取',
    analyzeDraft: 'Gemini 3 深度分析',
    analyzing: '分析中...',
    contentDescription: 'Gemini 3 內容解析',
